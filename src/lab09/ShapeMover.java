                                                  ...
                                                  Runnable
{
    ...
    public ShapeMover ()
    {
    	...
    	shapes = new Shape[]
    	    {
    	       new Rect    (130,  40,  60, 80, Color.RED),
               new Rect    (230,  40,  20, 50, Color.BLUE),
               new Rect    (330,  40,  80, 40, Color.GREEN.darker()),
               new Rect    (130, 140, 100, 50, new Color (0.8f, 0.6f, 0.2f)),
    	       new Rect    ( 30, 140,  40, 50, Color.YELLOW),
               new Circle  (230, 140,  30, Color.PINK),
               new Circle  (430, 140,  60, Color.ORANGE),
               new Circle  (430, 340,  20, Color.MAGENTA),
               new Circle  (130, 340, 100, Color.CYAN),
               new Circle  ( 30, 340,  50, Color.GRAY)
    	    };
    ...
    public void paint (Graphics g)
    {
    	...
    	for (Shape s : shapes) // Rect s: shapes ----------------------------------------------------------------------------------------------------------------------------
    	    s.draw(g);
    }
